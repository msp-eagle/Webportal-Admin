...
@Component({
  selector: 'app-biopart-edit',
  templateUrl: './biopart-edit.component.html',
  styleUrls: ['./biopart-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class BiopartEditComponent implements OnInit{
  ...
  constructor(private formBuilder:FormBuilder,private aboutService:OperamodelService,
