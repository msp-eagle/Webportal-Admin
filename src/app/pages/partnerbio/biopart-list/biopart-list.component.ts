...
@Component({
  selector: 'app-biopart-list',
  templateUrl: './biopart-list.component.html',
  styleUrls: ['./biopart-list.component.css']
})
export class BiopartListComponent {
  maxSize = 5;
  totalItems: number;
  currentPage = 1;
  start: number = 0;
  ...
  constructor(public aboutService: BiopartService){
