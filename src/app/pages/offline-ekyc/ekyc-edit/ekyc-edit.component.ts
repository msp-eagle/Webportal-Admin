...
@Component({
  selector: 'app-ekyc-edit',
  templateUrl: './ekyc-edit.component.html',
  styleUrls: ['./ekyc-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class EkycEditComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private aboutService:EkycService,
  ...
  onSubmit(): void {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.router.navigate(['/ekyc-list'])
      }
