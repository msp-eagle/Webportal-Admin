...
import {CompositionService} from "../../../service/phisyscouncial/composition/composition.service";
...
export class CompositionEditComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private compositionService:CompositionService,
  ...
  onSubmit(): void {
    ...
    // this.compositionService.update(this.id,formdata).subscribe(response => {
    //
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.compositionService.update(this.id,formdata).subscribe(
          (response) => {
        ...
        this.router.navigate(['/cms/council/composition'])
      }
  ...
  view() {
    this.compositionService.view(this.id).subscribe(
      res => {
