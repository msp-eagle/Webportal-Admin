...
@Component({
  selector: 'app-fintion-list',
  templateUrl: './fintion-list.component.html',
  styleUrls: ['./fintion-list.component.css']
})
export class FintionListComponent {
  ...
  list(id: any) {
    this.functionService.list(id).subscribe(
      res => {
        this.content = res;
