...
export class ResolutionComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private resolutionService:ResolutionService,private router: Router){
  ...
  onSubmit(): void {
    ...
    // this.resolutionService.create(formdata).subscribe(response => {
    //
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.resolutionService.create(formdata).subscribe(
          (response) => {
            this.response = response;
