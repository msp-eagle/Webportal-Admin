...
export class CompositionComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private compositionService:CompositionService,private router: Router){
  ...
  onSubmit(): void {
    ...
    // this.compositionService.create(formdata).subscribe(response => {
    //
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.compositionService.create(formdata).subscribe(
          (response) => {
            this.response = response;
