...
constructor(private formBuilder:FormBuilder,private router: Router,private homeServcie:HomeService){
        ...
        onSubmit(): void {
          ...
          formdata.append('content', this.formgroup.get('content').value);
           this.homeServcie.create(formdata).subscribe(response => {
          ...
          title: 'Are you sure?',
            ...
            if (result.value) {
              this.homeServcie.create(formdata).subscribe(
                (response) => {
                  this.response = response;
