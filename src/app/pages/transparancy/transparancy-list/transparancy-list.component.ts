...
@Component({
  selector: 'app-transparancy-list',
  templateUrl: './transparancy-list.component.html',
  styleUrls: ['./transparancy-list.component.css']
})
export class TransparancyListComponent implements OnInit{
  maxSize = 5;
  totalItems: number;
  currentPage = 1;
  start: number = 0;
  ...
  constructor(public transparancyService:TransparancyService){
  ...
  list(id:any) {
    this.transparancyService.list(id).subscribe(
      res => {
        this.content = res;
  ...
  delete(id:any){
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.transparancyService.delete(id)
          .subscribe(res=>{
