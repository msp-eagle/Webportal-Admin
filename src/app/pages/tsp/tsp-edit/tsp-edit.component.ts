...
import {TspService} from "../../../service/partners/tsp.service";
import Swal from "sweetalert2";

@Component({
  selector: 'app-tsp-edit',
  templateUrl: './tsp-edit.component.html',
  styleUrls: ['./tsp-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class TspEditComponent implements OnInit {
  ...
  constructor(private router: Router,private formBuilder:FormBuilder,private aboutService:TspService,private route: ActivatedRoute,){
