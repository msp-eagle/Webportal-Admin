...
@Component({
  selector: 'app-tsp-list',
  templateUrl: './tsp-list.component.html',
  styleUrls: ['./tsp-list.component.css']
})
export class TspListComponent {
  maxSize = 5;
  totalItems: number;
  currentPage = 1;
  start: number = 0;
  ...
  constructor(public aboutService: TspService){
