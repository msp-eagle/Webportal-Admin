...
@Component({
  selector: 'app-devsection-edit',
  templateUrl: './devsection-edit.component.html',
  styleUrls: ['./devsection-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class DevsectionEditComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private aboutService:DevsecService,
  ...
  onSubmit(): void {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.router.navigate(['/devsec-list'])
      }
