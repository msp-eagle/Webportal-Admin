...
@Component({
  selector: 'app-relyingparty',
  templateUrl: './relyingparty.component.html',
  styleUrls: ['./relyingparty.component.css'],
...
export class RelyingpartyComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private relpartyService:RelpartyService,private router: Router){
