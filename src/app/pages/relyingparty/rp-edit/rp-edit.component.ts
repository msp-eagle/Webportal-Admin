...
@Component({
  ...
  templateUrl: './rp-edit.component.html',
  styleUrls: ['./rp-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class RpEditComponent implements OnInit {
  ...
  constructor(private router: Router,private formBuilder:FormBuilder,private aboutService:RelpartyService,private route: ActivatedRoute,){
