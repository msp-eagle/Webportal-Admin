...
@Component({
  selector: 'app-aboutbrief-edit',
  templateUrl: './aboutbrief-edit.component.html',
  styleUrls: ['./aboutbrief-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class AboutbriefEditComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private aboutService:AboutbriefService,private route: ActivatedRoute,private router:Router){
  ...
  onSubmit(): void {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.router.navigate(['/cms/philsys-briefer'])
      }
