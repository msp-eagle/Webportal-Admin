...
@Component({
  selector: 'app-aboutbrief',
  templateUrl: './aboutbrief.component.html',
  styleUrls: ['./aboutbrief.component.css'],
...
constructor(private formBuilder:FormBuilder,private aboutService:AboutbriefService, private router: Router){
