...
@Component({
  selector: 'app-devbio',
  templateUrl: './devbio.component.html',
  styleUrls: ['./devbio.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class DevbioComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private router: Router,private relpartyService:BiodevService){
  ...
  onSubmit(): void {
    ...
    title: 'Are you sure?',
      ...
      if (result.value) {
        ...
        this.router.navigate(['/biodev-list'])
      }
