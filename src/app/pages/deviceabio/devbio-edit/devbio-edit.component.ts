...
@Component({
  selector: 'app-devbio-edit',
  templateUrl: './devbio-edit.component.html',
  styleUrls: ['./devbio-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class DevbioEditComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private aboutService:BiodevService,
