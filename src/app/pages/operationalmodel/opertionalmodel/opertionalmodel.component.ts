...
@Component({
  selector: 'app-opertionalmodel',
  templateUrl: './opertionalmodel.component.html',
  styleUrls: ['./opertionalmodel.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class OpertionalmodelComponent implements OnInit {
  ...
  private operamodelService:OperamodelService){
