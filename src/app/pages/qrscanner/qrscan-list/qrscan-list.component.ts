...
@Component({
  selector: 'app-qrscan-list',
  templateUrl: './qrscan-list.component.html',
  styleUrls: ['./qrscan-list.component.css']
})
export class QrscanListComponent {
  maxSize = 5;
  totalItems: number;
  currentPage = 1;
  start: number = 0;
  ...
  constructor(public aboutService: QrcodeService){
