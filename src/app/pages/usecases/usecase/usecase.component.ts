...
export class UsecaseComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private usecaseService:UsecaseService,private router: Router){
  ...
  onSubmit(): void {
    ...
    // this.usecaseService.create(formdata).subscribe(response => {
    //
    ...
    title: 'Are you sure?',
      ...
      if (result.value) {
        this.usecaseService.create(formdata).subscribe(
          (response) => {
            this.response = response;
