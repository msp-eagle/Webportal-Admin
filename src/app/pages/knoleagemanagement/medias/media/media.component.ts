...
import {MediaService} from "../../../../service/knowlagemanagement/media.service";
...
export class MediaComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private router: Router,private mediaService:MediaService){
  ...
  onSubmit(): void {
    ...
    // this.mediaService.create(formdata).subscribe(response => {
    //
    ...
    title: 'Are you sure?',
      ...
      if (result.value) {
        ...
        this.router.navigate(['/mediakno-list'])
      }
