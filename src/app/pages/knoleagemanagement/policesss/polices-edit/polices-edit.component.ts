...
@Component({
  selector: 'app-polices-edit',
  templateUrl: './polices-edit.component.html',
  styleUrls: ['./polices-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class PolicesEditComponent implements OnInit {
...
public quickTools: object = {
  ...
  constructor(private formBuilder:FormBuilder,private policesService:PolicesService,
  ...
  // this.policesService.update(this.id,formdata).subscribe(response => {
  //
  ...
  // });
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.policesService.update(this.id,formdata).subscribe(
          (response) => {
        ...
        this.router.navigate(['/policeskno-list'])
      }
  ...
  view() {
    this.policesService.view(this.id).subscribe(
      res => {
