...
export class ProceduresComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private router: Router,private proceduresService:ProceduresService){
  ...
  onSubmit(): void {
    ...
    // this.proceduresService.create(formdata).subscribe(response => {
    //
    ...
    title: 'Are you sure?',
      ...
      if (result.value) {
        this.proceduresService.create(formdata).subscribe(
          (response) => {
            this.response = response;
