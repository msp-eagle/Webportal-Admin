...
@Component({
  ...
  templateUrl: './procedures-edit.component.html',
  styleUrls: ['./procedures-edit.component.css'],
...
public quickTools: object = {
  ...
  constructor(private formBuilder:FormBuilder,private proceduresService:ProceduresService,
  ...
  // this.proceduresService.update(this.id,formdata).subscribe(response => {
  //
  ...
  // });
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.proceduresService.update(this.id,formdata).subscribe(
          (response) => {
        ...
        this.router.navigate(['/procedurekno-list'])
      }
  ...
  view() {
    this.proceduresService.view(this.id).subscribe(
      res => {
