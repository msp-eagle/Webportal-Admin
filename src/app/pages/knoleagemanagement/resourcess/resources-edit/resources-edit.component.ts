...
import {ResourcesService} from "../../../../service/knowlagemanagement/resources.service";
import {
  HtmlEditorService,
  ImageService,
...
public quickTools: object = {
  ...
  // this.resourcesService.update(this.id,formdata).subscribe(response => {
  //
  ...
  // });
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.resourcesService.update(this.id,formdata).subscribe(
          (response) => {
        ...
        this.router.navigate(['/resorceskno-list'])
      }
  ...
  view() {
    this.resourcesService.view(this.id).subscribe(
      res => {
