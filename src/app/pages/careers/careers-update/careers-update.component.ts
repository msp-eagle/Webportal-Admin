...
@Component({
  selector: 'app-careers-update',
  templateUrl: './careers-update.component.html',
  styleUrls: ['./careers-update.component.css']
})
export class CareersUpdateComponent implements OnInit{
  public value: string = `
  ...
  constructor(private formBuilder:FormBuilder,private aboutService:AboutbriefService,
