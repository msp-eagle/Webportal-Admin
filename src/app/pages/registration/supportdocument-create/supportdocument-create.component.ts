...
@Component({
  selector: 'app-supportdocument-create',
  templateUrl: './supportdocument-create.component.html',
  styleUrls: ['./supportdocument-create.component.css']
})
export class SupportdocumentCreateComponent implements OnInit{
  public value: string = `
  ...
  constructor(private formBuilder:FormBuilder,private supportdocumentService:SupportdocumentService,private router:Router){
  ...
  onSubmit(): void {
    ...
    // this.supportdocumentService.create(formdata).subscribe(response => {
    //
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.supportdocumentService.create(formdata).subscribe(
          (response) => {
            this.response = response;
