...
@Component({
  selector: 'app-privacy-update',
  templateUrl: './privacy-update.component.html',
  styleUrls: ['./privacy-update.component.css'],
...
constructor(private formBuilder:FormBuilder,private careersService:DataprivacyService,
...
// this.careersService.update(this.id,formdata).subscribe(response => {
//
...
// });
  ...
  Swal.fire({
    ...
    if (result.value) {
      this.careersService.update(this.id,formdata).subscribe(
        (response) => {
...
view() {
  this.careersService.view(this.id).subscribe(
    res => {
