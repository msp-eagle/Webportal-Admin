...
@Component({
  ...
  styleUrls: ['./privacy-create.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],
})
export class PrivacyCreateComponent implements OnInit{
  ...
  constructor(private formBuilder:FormBuilder,private router: Router,private dataprivacyService:DataprivacyService){
  ...
  onSubmit(): void {
    ...
    this.dataprivacyService.create(formdata).subscribe(response => {
    ...
    title: 'Are you sure?',
      ...
      if (result.value) {
        this.dataprivacyService.create(formdata).subscribe(
          (response) => {
            this.response = response;
        ...
        this.router.navigate(['/cms/data-privacy'])
      }
