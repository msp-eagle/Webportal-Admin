...
@Component({
  ...
  styleUrls: ['./legal-create.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class LegalCreateComponent implements OnInit{
  public value: string = `
  ...
  onSubmit(): void {
    ...
    // this.legalbaseService.create(formdata).subscribe(response => {
    //
    ...
    title: 'Are you sure?',
      ...
      if (result.value) {
        this.legalbaseService.create(formdata).subscribe(
          (response) => {
            this.response = response;
