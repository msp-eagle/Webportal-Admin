...
@Component({
  selector: 'app-legal-update',
  templateUrl: './legal-update.component.html',
  styleUrls: ['./legal-update.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class LegalUpdateComponent implements OnInit{
  ...
  constructor(private formBuilder:FormBuilder,private legaService:LegalbaseService,
  ...
  onSubmit(): void {
    ...
    // this.legaService.update(this.id,formdata).subscribe(response => {
    //
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.legaService.update(this.id,formdata).subscribe(
          (response) => {
        ...
        this.router.navigate(['/cms/legal-bases'])
      }
  ...
  view() {
    this.legaService.view(this.id).subscribe(
      res => {
