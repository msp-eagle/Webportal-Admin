...
@Component({
  selector: 'app-authdev-list',
  templateUrl: './authdev-list.component.html',
  styleUrls: ['./authdev-list.component.css']
})
export class AuthdevListComponent {
  maxSize = 5;
  totalItems: number;
  currentPage = 1;
  start: number = 0;
  ...
  constructor(public aboutService: AuthdevService){
