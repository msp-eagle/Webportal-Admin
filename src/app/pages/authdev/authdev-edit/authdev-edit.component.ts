...
@Component({
  selector: 'app-authdev-edit',
  templateUrl: './authdev-edit.component.html',
  styleUrls: ['./authdev-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],

})
export class AuthdevEditComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private aboutService:AuthdevService,private route: ActivatedRoute,private router: Router){
