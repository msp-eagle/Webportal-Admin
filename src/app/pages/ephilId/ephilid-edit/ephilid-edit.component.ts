...
@Component({
  selector: 'app-ephilid-edit',
  templateUrl: './ephilid-edit.component.html',
  styleUrls: ['./ephilid-edit.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],
})
export class EphilidEditComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private ephilidService:EphilidService,
