...
@Component({
  selector: 'app-ephilid',
  templateUrl: './ephilid.component.html',
  styleUrls: ['./ephilid.component.css'],
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService,TableService, QuickToolbarService],
})
export class EphilidComponent  implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private router: Router,private ephilidService:EphilidService){
  ...
  onSubmit(): void {
    ...
    this.ephilidService.create(formdata).subscribe(response => {
    ...
    title: 'Are you sure?',
      ...
      if (result.value) {
        this.ephilidService.create(formdata).subscribe(
          (response) => {
            this.response = response;
        ...
        this.router.navigate(['/ephilid-list'])
      }
