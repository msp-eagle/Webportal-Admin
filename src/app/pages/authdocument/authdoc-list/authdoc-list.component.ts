...
@Component({
  selector: 'app-authdoc-list',
  templateUrl: './authdoc-list.component.html',
  styleUrls: ['./authdoc-list.component.css']
})
export class AuthdocListComponent {
  maxSize = 5;
  totalItems: number;
  currentPage = 1;
  start: number = 0;
  ...
  constructor(public aboutService: AuthdocsService){
