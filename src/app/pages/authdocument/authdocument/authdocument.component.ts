...
@Component({
  selector: 'app-authdocument',
  templateUrl: './authdocument.component.html',
  styleUrls: ['./authdocument.component.css'],
...
export class AuthdocumentComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private relpartyService:AuthdocsService,private router: Router){
